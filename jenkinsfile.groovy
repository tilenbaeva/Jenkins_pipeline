node {
    properties([parameters([string(defaultValue: '127.0.0.1', description: 'Please give IP to host a Website', name: 'DEVIP', trim: true)])]), properties([pipelineTriggers([pollSCM('* * * * *')])])
